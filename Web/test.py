...
# #               dddd=dddd + asd_4   
    ...
    if age == None:
        hao=name
        for i in range(1):
            url='http://jia.wzhlovewjq1314.cn:801/eportal/?c=Portal&a=self&callback=dr1003&self_type=1&user_account='+hao+'&user_password=www&wlan_user_mac=50642baa65d7&wlan_user_ip=10.252.27.108&jsVersion=3.3.3&v=741'
            headers={
                "Accept":"*/*",
            ...
            zhongjianzhi=url1[0].replace('172.28.100.99:80','jia.wzhlovewjq1314.cn:8081')
...
app.run(host='0.0.0.0',port=8999,processes=True)# 1.threaded : 多线程支持，默认为False，即不开启多线程;
